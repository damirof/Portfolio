...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function creatUserCard() {
        products.forEach(product => {
            ...
            heartIcon.addEventListener("click", () => { toggleUserWishlist(product.id, heartIcon)
    ...
    function toggleUserWishlist(productId) {
        ...
        let currentProductIndex = (currentUser.wishlist || []).findIndex((item) => item.id === productId);
        ...
        if (currentProductIndex !== -1) {
            ...
            currentUser.wishlist.push(productToAdd);
            users[userIndex] = currentUser;
            localStorage.setItem("users", JSON.stringify(users));
